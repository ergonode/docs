...
full code example you can find in the   [product-sku-condition-module](https://github.com/ergonode/docs/tree/master/docs/backend/cookbook/examples/product-sku-condition-module)
