...
```php
<?php
# file product-sku-condition-module/src/Domain/ProductSkuCondition.php
...
```php
<?php
# file product-sku-condition-module/src/Infrastructure/Condition/ProductSkuConditionConfigurationStrategy.php
declare(strict_types=1);
...
```php
<?php
# file product-sku-condition-module/src/Infrastructure/Condition/ProductSkuConditionValidatorStrategy.php
declare(strict_types=1);
...
And finaly our module must # Sku condition
